...
from src.syslog_ng_config.statements.destinations.python_sngtestmod_destination import PythonSNGtestmodDestination
...
class SyslogNgConfig(object):
    ...
    def create_python_sngtestmod_destination(self, **options):
        return PythonSNGtestmodDestination(**options)
