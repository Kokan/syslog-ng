...
static CfgLexerKeyword main_keywords[] =
{
  ...
  { "default_level",      KW_DEFAULT_SEVERITY, KWS_OBSOLETE, "default_level has been deprecated" },
  { "default_priority",   KW_DEFAULT_SEVERITY, KWS_OBSOLETE, "default_priority has been deprecated" },
