...
static CfgLexerKeyword main_keywords[] =
{
  ...
  { "default_level",      KW_DEFAULT_LEVEL, KWS_OBSOLETE, "default_level has been deprecated" },
  { "default_priority",   KW_DEFAULT_LEVEL, KWS_OBSOLETE, "default_priority has been deprecated" },
